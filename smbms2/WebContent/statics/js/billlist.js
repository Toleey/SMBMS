...
function deleteBill(obj){
	$.ajax({
		type:"GET",
		url:path+"/sys/bill/deleteBillSave.do",
...
$(function(){
	...
	$(".viewBill").on("click",function(){
		...
		$.ajax({
			type:"GET",
			url:path+"/sys/bill/viewBillAjax.do",
			...
			success:function(result){
				...
				if("failed" == result){
					...
					$("#v_billCode").val(result.billCode);
					$("#v_productName").val(result.productName);
					$("#v_productUnit").val(result.productUnit);
					$("#v_productCount").val(result.productCount);
					$("#v_totalPrice").val(result.totalPrice);
					$("#v_proName").val(result.proName);
					$("#v_isPayment").val(result.isPayment);
				}
